...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @PostConstruct
    public void init() {
        List<User> users = (List<User>) userService.findAllNoPage();
        List<Role> roleList = (List<Role>) roleService.findAllNoPage();
        if (roleList.isEmpty()) {
